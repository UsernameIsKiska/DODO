    ...
    <div class="col-10 mx-auto">     
        <div class="row">   <!-- header -->
            ...
            <?php 
                ...
                $select1 = "SELECT * FROM trash"; 

                $query1 = mysqli_query($con,$select1);

                $pizza1 = $query1->fetch_assoc(); 
            ...
            <div class="bsk-box bg-white border rounded col-3 pt-3"> <!-- Корзина -->
                ...
                <div class="row">
                    <div class="col-3">
                        <img src="<?php echo $pizza1['img']; ?>" class="w-100">
                    </div>
                    <div class="col-4 mt-2">
                        <h5><?php echo $pizza1['name']; ?></h5>                        
                    </div>
                    <div class="col-2 mt-2 px-0 text-center">
                        <h5><?php echo $pizza1['price']; ?> <span>₽</span></h5>                        
                    </div>
            ...
            <div class="col-3">   
                ...
                <div class="row">
                    ...
                    <form action="insert.php" method="GET">
                        <input style="display: none;" type="" name="id" value="<?php echo $pizza['id']?>">
